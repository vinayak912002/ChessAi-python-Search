...
class Board:
    ...
    @classmethod
    #new is a special way to initialize the class
    #it takes no arguments and returns a class object
    def new(cls):
        ...
        chess_pieces[0][Board.HEIGHT-1] = pieces.Rook(0, Board.HEIGHT, pieces.Piece.WHITE)
            ...
            for y in range(Board.HEIGHT):
                ...
                if(piece!=0):
                    if(piece.color == color):
                        moves += piece.get_possible_moves(self)#this get_possible_moves is of the piece and not the board
        return moves
    ...
    def perform_move(self, move):
        ...
        if (piece.piece_type == pieces.King.PIECE_TYPE):
            ...
            #if king has moves 2 places to the right
            ...
            #if king moves 2 places to the left
            if(move.xto - move.xfrom == -2):
    ...
    #function to check if the given color is in check or not
