...
class Heuristics:
    ...
    #the tables denote the favourability of that chess piece in that position
    ...
    #the evaluation is done with the perspective of white pieces. i.e. positive means favourable for white and negative means favourable for black
    @staticmethod
